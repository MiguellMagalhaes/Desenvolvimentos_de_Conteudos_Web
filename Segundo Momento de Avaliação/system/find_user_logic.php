...
<html lang="pt">
  ...
  <head>
    ...
    <title> Encontrar Utilizador </title>
...
<div class="quatro">
	...
	<tr bgcolor='#CCCCCC'>
        ...
        print "<td><a href=\"edit.php?id=$res[id]\">Editar</a> | <a href=\"delete.php?id=$res[id]\" onClick=\"return confirm(' Tem a certeza que deseja eliminar?\\nEsta ação não pode ser desfeita!')\">Apagar</a></td>";		
